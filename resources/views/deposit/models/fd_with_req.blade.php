                ...
                <div class="modal-content " style="width: 800px;height: auto">
                    <div>
                        <div class="row mt-5 ml-3">
                            <label class="col-sm-2 col-form-label">FD Client Full Name</label>
                            <div class="col-sm-10">
                                <div class="row">
                                    <div class="col">
...
function set_cus_details_from_modal(id){
    ...
    customer_data.filter(cus => {
        if(cus.id === parseInt(id)){
            ...
            if(document.querySelector('#fd_amount')){
                fd_amount.value = cus.deposite_amount
            }
            if(document.querySelector('#account_id')){
                account_id.value = cus.deposite_amount
            }
