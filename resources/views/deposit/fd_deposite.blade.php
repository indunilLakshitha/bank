        ...
        <div class="card ">
            <div class="card-body ">
                <div class="card-header card-header-rose card-header-text">
                    <div class="card-text">
                        <h4 class="card-title">FD Deposit</h4>
                    </div>
                </div>
                ...
                <div class="row">
                    <label class="col-sm-2 col-form-label">FD Value</label>
                    <div class="col-sm-6">
                        <div class="form-group">
...
<script type="text/javascript">
    ...
    $.ajaxSetup({
            ...
            function normalWithdraw(amount,customer_id,account_id,payment_method_id){
                ...
                if(parseInt(deposited.value)==1){
                    return Swal.fire('Already Deposited')
                    dep_btn.classList.add('d-none')
