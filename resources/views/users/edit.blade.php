                ...
                <div class="col-10">
                    <div class="form-group">
                        <div class="row">
                            ...
                            <div class="col-sm-5">
                                <div class="form-group">
                                    <input type="hidden" name="status" class="form-control" value="{{ $user->status}}"
                                        required>
                            ...
                            <div class="col-sm-5">
                                <div class="form-group">
                                    <input type="text" name="email" class="form-control"
                                        value="{{ isset($user->email) ? $user->email: ''}}" required readonly>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            ...
                            <div class="col-sm-5">
                                <div class="form-group">
                                    <input type="text" name="mobile_number" class="form-control"
                                        value="{{ isset($user->mobile_number) ? $user->mobile_number: ''}}" required>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            ...
                            <div class="col-sm-5">
                                <div class="form-group">
                                    <input type="text" name="employee_no" class="form-control"
                                        value="{{ isset($user->employee_no) ? $user->employee_no: ''}}" required
                                        readonly>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="col-sm-5">
                                <div class="form-group">
                                    <input type="text" name="nic" class="form-control"
                                        value="{{ isset($user->nic) ? $user->nic: ''}}" readonly>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-3">
                                {{-- <tr> --}}
                                {{-- <th> --}}
                                <input type="checkbox" {{-- @foreach ($all_roles as $r)
                                    @foreach ($r->permissions as $perm)
                                        @if ($perm->name == $p->name)

                                        @endif
                                    @endforeach
                                @endforeach --}} value="{{$p->name}}" class="perm_checkboxes " name="permissions[]"
                                    id="{{$p->name}}">
                                {{$p->view_name}}
                                {{-- </th> --}}
                                {{-- </tr> --}}
