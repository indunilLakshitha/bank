            ...
            <div class="card " style="border: solid">
                ...
                <div class="card-body">
                    ...
                    <form id="form" method="POST">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-3 col-md-3 col-sm-3">
                                <div class="form-group">
                                    <input name="customer_id" type="text" disabled class="form-control"
                                        id="customer_id">
                                </div>
                            </div>
                        </div>
                        ...
                        @php
                        $share_amount = DB::table('setting_data')->where('setting_description',
                        'share_amount')->first()->setting_data;
                        @endphp
                        ...
                        <div class="row">
                            <div class="col-6 text-right">
                                <button type="button" onclick="buy_shares()"
