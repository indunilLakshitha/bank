...
<head>
  <meta charset="utf-8" />
  <link rel="apple-touch-icon" sizes="76x76" href="{{asset('mat_ui/img/apple-icon.png')}}">
  <link rel="icon" type="image/png" href="{{asset('mat_ui/img/favicon.png')}}">
...
<body class="off-canvas-sidebar">
  ...
  <div class="wrapper wrapper-full-page">
    <div class="page-header login-page header-filter" filter-color="black" style="background-image: url('{{asset('mat_ui/img/sidebar-1.gif')}}'); background-size: cover; background-position: top center;">
