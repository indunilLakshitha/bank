    ...
    <div class="card " style="border: solid">
        ...
        <div class="col-md-12 ">
            ...
            <div class="card-body ">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-8">
                        <div class="row">
                            <div class="col-8">
                                <div class="form-group">
                                    <input type="text" name="full_name" readonly class="form-control" id="full_name">
                                </div>
                            </div>
                ...
                <div class="row">
                    <label class="col-sm-2 col-form-label">Iedentification Number</label>
                    <div class="col-sm-4">
                        <div class="form-group">
                            <input type="text" class="form-control" readonly id="identification_number"
                ...
                <div class="row">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-5 checkbox-radios ml-3">
                            <div class="form-check">
                                <label class="form-check-label">
                                    <input class="form-check-input" checked type="checkbox" name="has_sms" value="1">
                                    SMS
                                    <span class="form-check-sign">
                                        <span class="check"></span>
                                    </span>
                        ...
                        <div class="col-sm-5 checkbox-radios ml-3">
                            <div class="form-check">
                                <label class="form-check-label">
                                    <input class="form-check-input" type="checkbox" name="has_internet_banking"
                                        value="1">
                                    Internet Banking
                                    <span class="form-check-sign">
                                        <span class="check"></span>
                ...
                <div class="row mt-3">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-3 checkbox-radios " style="margin-left: 44px">
                            <div class="form-check">
                                <label class="form-check-label">
                                    <input class="form-check-input" type="checkbox" name="has_account_statement"
                                        value="1">
                                    Account Statement
                                    <span class="form-check-sign">
                                        <span class="check"></span>
