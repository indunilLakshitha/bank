                        ...
                        <div class="material-datatables">
                            <table id="datatables" class="table table-striped table-no-bordered table-hover"
                                ...
                                <tbody id="results_tbody">
                                    <?php
                                     $members=\App\WithdrawalRequests::leftjoin('fd_account_general_information','fd_account_general_information.account_id','fd_withdrawal_requests.fd_account_id')
                                     ->leftjoin('customer_basic_data', 'customer_basic_data.customer_id', 'fd_account_general_information.customer_id')
                                     ->where('fd_withdrawal_requests.status','2')
                                     ->select('customer_basic_data.*','fd_account_general_information.*')
                                     ->get();
                                    ?>
                                    @isset($members)
